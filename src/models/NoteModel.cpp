                                    ...
                                    QString linkedNotebookGuid, QList<Note> foundNotes, QUuid requestId)
{
    ...
    NMINFO(QStringLiteral("NoteModel::onListNotesComplete: flag = ") << flag << QStringLiteral(", with resource metadata = ")
                                  ...
                                  QString linkedNotebookGuid, ErrorString errorDescription, QUuid requestId)
{
    ...
    NMWARNING(QStringLiteral("NoteModel::onListNotesFailed: flag = ") << flag << QStringLiteral(", with resource metadata = ")
            << (withResourceMetadata ? QStringLiteral("true") : QStringLiteral("false")) << QStringLiteral(", with resource binary data = ")
